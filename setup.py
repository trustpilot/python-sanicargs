...
requirements = ["sanic>=18.12", "ciso8601>=2.1.3"]

test_requirements = ["pytest==5.4.1", "pytest-sanic>=1.6.0"]

extras = {"test": test_requirements + requirements}

# get version
metadata = {}
version_filename = os.path.join(
    os.path.dirname(__file__), "sanicargs", "__version__.py"
)
...
setup(
    ...
    packages=["sanicargs",],
    package_dir={"sanicargs": "sanicargs"},
